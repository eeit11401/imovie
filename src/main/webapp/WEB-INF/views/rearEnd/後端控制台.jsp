...
<link rel="canonical"
  ...
  <!-- simplebar CSS-->
  <link href="${pageContext.request.contextPath}/plugins/simplebar/css/simplebar.css"type="text/css" rel="stylesheet"/>
  <!-- Bootstrap core CSS-->
  <link href="${pageContext.request.contextPath}/css/bootstrap.min.css"type="text/css" rel="stylesheet"/>
  <!-- animate CSS-->
  <link href="${pageContext.request.contextPath}/css/animate.css"type="text/css"rel="stylesheet" type="text/css"/>
  <!-- Icons CSS-->
  <link href="${pageContext.request.contextPath}/css/icons.css"type="text/css"rel="stylesheet" type="text/css"/>
  <!-- Sidebar CSS-->
  <link href="${pageContext.request.contextPath}/css/sidebar-menu.css" type="text/css"rel="stylesheet"/>
  <!-- Custom Style-->
  <link href="${pageContext.request.contextPath}/css/app-style.css"type="text/css" rel="stylesheet"/>
